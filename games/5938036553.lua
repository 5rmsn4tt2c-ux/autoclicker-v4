...
local drawingactor = loadstring(downloadFile('autoclicker-v4/libraries/drawing.lua'), 'drawing')(...)
...
if not select(1, ...) and game.PlaceId == 5938036553 then
	if run_on_actor and getactors then
		...
		task.spawn(function()
			...
			local executionString = "loadfile('autoclicker-v4/main.lua')(" .. drawingactor .. ')'
